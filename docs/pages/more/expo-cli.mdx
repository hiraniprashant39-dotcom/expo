...
// This is a single-file React demo for the "મારી વાડી" app UI.
...
export default function MariVadiApp() {
  ...
  const [crops, setCrops] = useState([
    { id: 1, name: "કેરી", water: "3 લિટર/દિવસ", pesticide: "Neem Oil", notes: "ફૂલ આવી રહ્યા છે" },
    { id: 2, name: "ચીકુ", water: "2 લિટર/દિવસ", pesticide: "None", notes: "મૃદા સૂકી" }
  ]);
  ...
  const [reminders, setReminders] = useState([
    { id: 1, text: "આજે ચીકુ પર દવા છાંટવી" },
    { id: 2, text: "દ્રાક્ષને પાણી આપવું" }
  ]);
  ...
  return (
    <div className="min-h-screen bg-green-50 p-6">
      <h1 className="text-3xl font-bold text-green-700 mb-6 text-center">🌿 મારી વાડી — ડેશબોર્ડ</h1>
      ...
      <div className="grid md:grid-cols-3 gap-4 mb-6">
        <Card>
          <CardContent className="flex items-center justify-between p-4">
            <div>
              <h2 className="text-xl font-semibold text-gray-700">આજનું હવામાન</h2>
              <p className="text-gray-600">તાપમાન: 32°C | વરસાદની શક્યતા: 40%</p>
            </div>
          ...
          <CardContent className="p-4 text-gray-700">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2"><DollarSign className="w-5 h-5"/> <div>
                <div className="text-sm">કુલ ખર્ચ</div>
                <div className="font-semibold">₹ 12,500</div>
              </div></div>

              <div className="flex items-center gap-2"><Sprout className="w-5 h-5"/> <div>
                <div className="text-sm">આવક</div>
                <div className="font-semibold text-green-700">₹ 28,000</div>
              </div></div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4 text-gray-700">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm">આજની સૂચનાઓ</div>
                <div className="font-medium">{reminders.length} સૂચન થયા છે</div>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-2xl font-semibold text-green-700">🌾 પાક મેનેજમેન્ટ</h2>
          <Button onClick={() => setShowAddCrop(!showAddCrop)} className="flex items-center gap-2"><Plus className="w-4 h-4"/> નવું પાક ઉમેરો</Button>
        </div>
            ...
            <CardContent>
              <form onSubmit={addCrop} className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  ...
                  <Input value={newCrop.name} onChange={e => setNewCrop({...newCrop, name: e.target.value})} placeholder="જેમ - કેરી" />
                </div>
                <div>
                  <Label>પાણી</Label>
                  <Input value={newCrop.water} onChange={e => setNewCrop({...newCrop, water: e.target.value})} placeholder="જેમ - 3 લિટર/દિવસ" />
                </div>
                <div>
                  <Label>દવા / ખાતર</Label>
                  <Input value={newCrop.pesticide} onChange={e => setNewCrop({...newCrop, pesticide: e.target.value})} placeholder="જેમ - Neem Oil" />
                </div>
                <div>
                  <Label>નોંધ</Label>
                  <Textarea value={newCrop.notes} onChange={e => setNewCrop({...newCrop, notes: e.target.value})} placeholder="ઓછા શબ્દોમાં નોંધો" />
                </div>
                <div className="md:col-span-2 flex justify-end gap-2">
                  <Button type="button" onClick={() => setShowAddCrop(false)}>રદ કરો</Button>
                  <Button type="submit" className="bg-green-600 text-white">ઉમેરો</Button>
                </div>
              </form>
            </CardContent>
          </Card>
              ...
              <CardContent>
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">પાણી: {crop.water}</p>
                    <p className="text-sm text-gray-500">દવા: {crop.pesticide}</p>
                    <p className="text-sm mt-2">{crop.notes}</p>
                  </div>
                  <div className="flex flex-col items-end gap-2">
                    <Button className="text-sm">વિગત જુઓ</Button>
                    <Button className="text-sm">સંપાદિત કરો</Button>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-2xl font-semibold text-green-700">🗺️ વાડીનો નકશો</h2>
          <div className="text-sm text-gray-500 flex items-center gap-2"><MapPin className="w-4 h-4"/> સ્થાન જોડવા માટે પરવાનગી આપો</div>
        </div>

        <Card>
          <CardContent className="p-0">
            {/* Placeholder map — replace with Google Maps component and API key in production */}
